...
where
  ...
  and
    (:min_age is null or extract(year from age(current_date, staff.birthdate)) > :min_age)
  and
    (:max_age is null or extract(year from age(current_date, staff.birthdate)) < :max_age)
  and
